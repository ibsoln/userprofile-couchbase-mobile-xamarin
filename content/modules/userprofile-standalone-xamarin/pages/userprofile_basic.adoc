...
Open
{githubsrc}/UserProfileDemo.iOS/AppDelegate.cs[`AppDelegate.cs`] in the `UserProfileDemo.iOS` project.

[source,c#]
----

include::example$/src/UserProfileDemo.iOS/AppDelegate.cs[tags=activate,indent=0]
...
// Open
// {githubsrc}/UserProfileDemo.UWP/MainPage.xaml.cs[`MainPage.xaml.cs`] in the `UserProfileDemo.UWP` project.

// [source,c#]
// ----
// include::example$/src/UserProfileDemo.UWP/MainPage.xaml.cs[tags=activate,indent=0]
// ----
